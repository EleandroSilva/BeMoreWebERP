...
type
  TFiredacMySQL = class(TInterfacedObject, iConexao)
    private
...
constructor TFiredacMySQL.Create;
begin
...
class function TFiredacMySQL.New: iConexao;
begin
  Result := Self.Create;
end;

function TFiredacMySQL.Connection: TCustomConnection;
begin
  try
...
function TFiredacMySQL.VendorLib: String;
begin
